...
import SiteInConstructionLayout from './modules/_layouts/Layouts/SiteInConstruction.layout.vue';
...
Vue.component('SiteInConstructionLayout', SiteInConstructionLayout);
