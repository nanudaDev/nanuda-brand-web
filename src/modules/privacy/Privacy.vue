        ...
        <section class="article-section p-5 border  bg-white">
          ...
          <div class="section-content">
            <div class="agree-box">
              <h4>제1조 (목적)</h4>
              <p>
                이 정책은 주식회사 위대한상사(이하 “회사”)가 이용자의 정보수집의
                과정에 있어서 기본적으로 이행해야 할 개인정보보호정책을 규정함을
                목적으로 합니다
              </p>
            </div>
            <div class="agree-box">
              <h4>제2조 (개인정보보호)</h4>
              <p>
                “회사”는 이용자의 정보수집 시 서비스 이용계약 이행에 필요한
            ...
            <div class="agree-box">
              ...
              <div class="o-list">
                <ol>
                  ...
                  <li>
                    “회원”이 자신의 ID 및 비밀번호를 도난 당하거나 제3자가
            ...
            <div class="agree-box">
              ...
              <div class="o-list">
                <ol>
                  <li>
                    “회사”와 이용자간에 발생한 전자상거래 분쟁에 관한 소송은
                  ...
                  <li>
                    “회사”와 이용자간에 제기된 전자상거래 소송에는 한국법을
                    적용합니다.
                  </li>
                </ol>
              </div>
